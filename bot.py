...
if __name__ == "__main__":
    ...
    if message.text == "✅ Submit Task":
        ...
        msg = bot.send_message(message.chat.id, f"Enter your {message.text} Number:")
        bot.register_next_step_handler(msg, lambda m, meth=message.text: final_wd_logic(m, meth))
